...
# Export all crop tables into one Excel file with each crop as a tab
write_xlsx(table2_by_crop, path = "../../Data_processing/6_generate_tables/2025_07_14/Table2_all_crops.xlsx")


# note: script for Tables 3- Table 7 not pushed to Github yet
